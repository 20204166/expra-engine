...
def build_server(cfg: ExpraMcpConfig) -> MCPServer:
    ...
    @server.tool(
        ...
        description=(
            ...
            "'capture_viewport' (returns an actual MCP image of the pygame-rendered layer; "
            "Canvas-drawn overlays like grid/collider outlines are not included) round out "
            "the action set. 'frame_scene' reports available=false: no such method exists in "
